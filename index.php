							...
							<form id="form_1" method="post">
								<div class="pad1">
									...
									<div class="row_select">
										Estado:<br>
										<!--<input type="text" class="input">  asi estaba originalmente -->
											<select name"estado" id="estado">
												<option value="">- Seleccione un Estado -</option> </select>
											<?php
											$estados = dameEstado();
									...
									<div class="row_select">
										Search Area:<br>
										<select><option>&nbsp;</option><option>Estado de México</option><option>Distrito Federal</option></select>
									</div>
									<div class="row_select">
										<div class="cols">
											Price Range:<br>
